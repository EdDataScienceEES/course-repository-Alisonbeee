...
---
## above is a YAML Header : it goes at the top of a Rmarkdown script
## three backwards apostrophes ``` (grave accents!). These are known ## as code chunks and look like this:
```{r}
